...
const BestPrice = () => {
    return (
        <div className="relative w-full overflow-hidden">
            ...
            <img src={bottomCurve} className="w-full relative" />
            ...
            <div className="absolute left-0 top-0 w-[54vw] w-min-fit mt-52">
                <div className="flex flex-col items-end">
                    <div className="flex flex-col items-end pb-4">
                        <span className="text-slate-600 text-[40px] font-normal leading-[65px]">
                            BEST PRICE<br/>
                        </span>
                        <span className="text-slate-600 text-[64px] font-bold leading-[65px]">
                            Agate Phone Grip
                        </span>
                    </div>
                    <div className='flex items-center justify-end gap-5 py-2'>
                        <div className="text-center text-teal-500 text-2xl font-normal line-through leading-[30px]">
                            44.50$
                        </div>
                        <div className="text-center text-red-500 text-[70px] font-bold">
                            19.50$
                        </div>
                    </div>
                    <div className="w-[400px] text-right text-slate-600 text-base font-normal leading-normal">
